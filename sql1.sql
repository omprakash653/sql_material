...
insert into customer_info(id,first_name,last_name) values(1,"Om","Yadav");

insert into customer_info(id,first_name,last_name) values(2,"Om1","Yadav1");

select * from customer_info;

insert into customer_info values(3,'Om2','Yadav2'),(4,'Om3','Yadav3');
insert into customer_info(id,first_name,last_name) values(5,"Om","Yadav1");

select * from customer_info where last_name="Yadav1" or last_name="Yadav";
select * from customer_info where last_name="Yadav1" and first_name="Om";
...
insert into customer_info(first_name,last_name,salary) values("Om","Yadav",20000);
insert into customer_info(first_name,last_name,salary) values("Om1","Yadav1",20000);

insert into customer_info(id,first_name,last_name,salary) values(1,"Om","Yadav",20000);
...
insert into employee(id,housenumber,pancard,first_name,last_name,salary) values(1,1,1,"Om","Yadav",20000);

insert into employee values(2,2,1,"Om1","Yadav1",20000);
...
insert into student(first_name,last_name) values("Om","Yadav"),("Om","Yadav");
...
insert into person values(1,"Om","Yadav",32),(2,"Om","Yadav",32);
...
insert into person
values(4,'raj','gupta',21);

desc orders;

select * from orders;

insert into person values(1,"Om","Yadav",32);

insert into person values(2,"Om1","Yadav1",31),
(3,"Shivam","Savitha",30),(4,"Darius","Bengali",27);
